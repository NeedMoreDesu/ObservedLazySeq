...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ObservedLazySeq.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Oleksii Horishnii/ObservedLazySeq'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Oleksii Horishnii' => 'oleksii.horishnii@gmail.com' }
  s.source           = { :git => 'https://github.com/Oleksii Horishnii/ObservedLazySeq.git', :tag => s.version.to_s }
